...
<body>
	  ...
	  <div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		  <ul class="nav navbar-nav">
			...
			<li class="active"><a href="realisasi.php">Realisasi <span class="sr-only">(current)</span></a></li>
	...
	<table class="w3-table-all w3-card-4" cellpadding="5" cellspacing="0" border="1">
		...
		$query = mysql_query("SELECT * FROM realisasi") or die(mysql_error());
		...
		if(mysql_num_rows($query) == 0){	//ini artinya jika data hasil query di atas kosong
			...
			while($data = mysql_fetch_assoc($query)){	//perulangan while dg membuat variabel $data yang akan mengambil data di database
				...
				echo '<tr>';
					...
					//echo '<td><a href='hapus.php?kode_res=$c[kode_res]'>Hapus </a></td>';
					

					echo '<td><a href="edit-rel.php?kode_res='.$data['kode_res'].'">Edit</a> 
					
					<td><a href="hapus_rel.php?kode_res='.$data['kode_res'].'">Hapus </a></td>';
