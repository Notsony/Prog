...
<body>
	...
	<nav class="navbar navbar-inverse">
	  <div class="container-fluid">
		...
		<div class="navbar-header">
		  ...
		  <a class="navbar-brand" href="index-pend.php">HMSI</a></li>
		</div>

		<!-- Collect the nav links, forms, and other content for toggling -->
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		  <ul class="nav navbar-nav">
			<li class="active"><a href="index-pend.php">Program Kerja <span class="sr-only">(current)</span></a></li>
	...
	<table class="w3-table-all w3-card-4" cellpadding="5" cellspacing="0" border="1">
		...
		$query = mysql_query("SELECT * FROM prog_kerja WHERE divisi='Pendidikan'") or die(mysql_error());
		...
		if(mysql_num_rows($query) == 0){	//ini artinya jika data hasil query di atas kosong
			...
			while($data = mysql_fetch_assoc($query)){	//perulangan while dg membuat variabel $data yang akan mengambil data di database
				...
				echo '<tr style="height: 40px;">';
					...
					echo '<td style="background-color:#66ff99"><a href="hasil-realisasi-pend.php?kode_prog='.$data['kode_prog'].'" target="_blank">Lihat</a></td>';
